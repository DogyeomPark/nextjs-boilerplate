...
/**
 * @title nest boilerplate api
 * @version 0.0.1
 * @contact
 *
 * nest.js로 빌드된 dialogue-engine
 */
export class Api<
...
> extends HttpClient<SecurityDataType> {
  user = {
     ...
     */
    userControllerSignIn: (data: SignInInput, params: RequestParams = {}) =>
      this.request<SignInOutput, any>({
        path: `/user/signin`,
        method: 'POST',
        body: data,
    ...
    /**
     * @description Receive an access token or a refresh token and delete the refresh token from the database. Then, put it in the cookie.
     *
    ...
    /**
     * @description After checking the refresh token, reissue the access token and put it in the cookie.
     *
